...
class med_rec:
    ...
    def display(self, root, string, level): 
        ...
        if level == 0:
            string = root.key_ret() + string[1:]    #from 1st to last character
        else:
        ...
        if root.isLeaf_ret():
            ...
            global display_list   #allows to modify variable outside current scope.
        ...
        def updt(bt):
            ...
            if not root:
                ...
                def chk():
                    ...
                    date = dtime[0].split("-")    #split is format specifier
...
class user_menu:
    ...
    def search_medicine(self):
        ...
        Label(search_win, text="\t  SEARCH MEDICINE RECORD").grid(row=1, column=0, columnspan=3)
    ...
    def show_each_medicine(self):
        ...
        show_win.title("Medicine record")
         ...
         #wrapper allows programmer to modify the behaviour of function or class
